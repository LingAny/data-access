...
class Request(object):
    ...
    @staticmethod
    def patch(url: str, data: Dict[str, Any] = None, is_json: bool = True, files=None) -> Response:
        headers, data = Request._prepare_data(data, is_json)
        return requests.patch(url, data=data, proxies=Request.proxies, headers=headers, files=files)
