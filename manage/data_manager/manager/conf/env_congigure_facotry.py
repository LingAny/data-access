...
class EnvConfigureFactory(object):
    ...
    def create() -> Configure:
        ...
        output_training_path = os.environ.get('OUTPUT_TRAINING_PATH')
        return Configure(list_path=list_path, dict_path=dict_path, output_reflections_path=output_reflections_path,
                         output_categories_path=output_categories_path, output_training_path=output_training_path)
